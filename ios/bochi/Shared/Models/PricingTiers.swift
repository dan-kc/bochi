...
// Shared cadence helpers for both recurringTask rewards and reward prices.
//
...
enum RecurringTaskDifficultyTier: String, PricingTierOption {
    case trivial
    case light
    case medium
    case hard
...
enum ImportanceTier: Int, PricingTierOption {
    case one = 1
    case two = 2
    case three = 3
    case four = 4
    ...
    nonisolated var shortDescription: String {
        ...
        case .five: "This is must-do, not something to bargain away."
        }
    }
    ...
    nonisolated static func from(_ rawValue: Int?) -> ImportanceTier? {
        guard let rawValue else { return nil }
        return ImportanceTier(rawValue: rawValue)
    }
}
