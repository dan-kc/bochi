        ...
        NavigationStack {
            List {
                    ...
                    if visibleReminders.isEmpty {
                        ...
                        ForEach(visibleReminders) { reminder in
                            HStack(alignment: .top, spacing: 12) {
                                ...
                                .accessibilityIdentifier("reminder.delete.\(reminder.id.rawValue)")
                            }
                        }
                    }
                }
                ...
                Section("Add Reminder") {
                    ...
                    .accessibilityIdentifier("reminder.date")
                    ...
                    if draftMode == .recurring {
                        ...
                        .accessibilityIdentifier("reminder.repeat.value")
                        ...
                        .accessibilityIdentifier("reminder.repeat.unit")
                    }
