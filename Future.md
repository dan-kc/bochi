...
- Review all tests and remove unecessary ones. I do not want to over test. Keep it all succinct.

- Refactor the Habit form and all of the associated modals. Make it as simple as possible using idiomatic SwiftUI.
